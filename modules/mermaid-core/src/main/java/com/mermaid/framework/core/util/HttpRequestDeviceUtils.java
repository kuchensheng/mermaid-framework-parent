...
public class HttpRequestDeviceUtils {
    ...
    /** ipad的User-Agent关键字 **/
    private static String[] ipadUserAgents = new String[] { "iPad", "AndroidPad", "pad"//iPad的ua，Mozilla/5.0 (iPad; U; CPU OS 3_2 like Mac OS X; zh-cn) AppleWebKit/531.21.10 (KHTML like Gecko) Version/4.0.4 Mobile/7B367 Safari/531.21.10
    };
