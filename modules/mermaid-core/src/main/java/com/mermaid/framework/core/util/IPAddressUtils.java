...
public class IPAddressUtils {
    ...
    public static boolean matches(String ip, String[] rules) {
        ...
        for(String rule : rules) {
            com.mermaid.framework.core.util.IPRange range = new com.mermaid.framework.core.util.IPRange(rule);
...
//        String ip = "192.168.100.34";
//        String rules = "192.168.0.0/24,192.168.100.0/24";
//        System.out.println(IPAddressUtils.matches(ip, rules));
//    }
}